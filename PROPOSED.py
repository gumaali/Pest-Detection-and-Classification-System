...
def PROPOSED(lyrebirds, obj_func, lb, ub, max_iterations):
    # Improved Lyrebird Optimization Algorithm (LOA)
    # Proposed position update is done at line 33
    ...
    for iteration in range(max_iterations):
        ...
        for _ in range(num_crossovers):
            ...
            alpha = (fitness[_] + np.min(fitness)) / (np.max(fitness))**2
